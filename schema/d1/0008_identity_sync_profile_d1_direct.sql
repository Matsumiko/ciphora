...
CREATE TABLE sync_profiles_next (
  ...
  provider_type TEXT NOT NULL CHECK (provider_type IN ('external_turso', 'external_d1_bridge', 'external_d1_direct')),
  provider_hint TEXT,
  label_hint TEXT,
...
INSERT OR IGNORE INTO identity_schema_migrations (version) VALUES ('0008_identity_sync_profile_d1_direct');
